...
public class IAMServiceUserManagerClientImpl implements IAMServiceUserManagerClient {
    ...
    public IAMServiceUserManagerClientImpl(String accessToken, String baseURL, OkHttpClient client, ObjectMapper mapper, OrganizationId organizationId, ProjectId projectId) {
