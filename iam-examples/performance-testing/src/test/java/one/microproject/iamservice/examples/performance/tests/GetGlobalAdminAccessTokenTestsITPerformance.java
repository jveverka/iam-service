...
import static one.microproject.iamservice.examples.performance.tests.ITTestUtils.scenariosPerSecond;
import static one.microproject.iamservice.examples.performance.tests.ITTestUtils.successRatePercent;
