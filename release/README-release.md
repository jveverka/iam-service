# IAM Service 2.4.3-RELEASE
Really simple standalone OAuth2/OIDC
[*Identity Access Management* (IAM) service](https://github.com/jveverka/iam-service/tree/2.4.3-RELEASE), 
...
* Start __iam-service__ (Requires JVM installed).
  ```
  java -Xms32m -Xmx128m -jar iam-service-2.4.3-RELEASE.jar --spring.config.location=file:application.yml
  ```
