...
* ``NEW_RELEASE_VERSION=2.5.6-RELEASE``
...
* Test created docker image.
  ...
  docker exec -it iam-service-2.5.6-RELEASE /bin/sh
  ```
...
* Publish docker manifest
  ...
  jurajveverka/iam-service:2.5.6-RELEASE \
  --amend jurajveverka/iam-service:2.5.6-RELEASE-amd64 \
  --amend jurajveverka/iam-service:2.5.6-RELEASE-arm64v8

  docker manifest push jurajveverka/iam-service:2.5.6-RELEASE
  ```